...
import com.example.examplemod.network.ExplosionParticle;
...
public class explosion_arrow extends AbstractArrow {

   public explosion_arrow(EntityType<explosion_arrow> p_36717_, Level p_36719_) {
      super(p_36717_, p_36719_, ItemStack.EMPTY);

   }

   public explosion_arrow(EntityType<explosion_arrow> p_36711_, double p_36712_, double p_36713_, double p_36714_, Level p_36715_) {
      super(p_36711_, p_36715_, ItemStack.EMPTY);
   }

   public explosion_arrow(EntityType<explosion_arrow> p_36721_, LivingEntity p_312718_, Level p_36722_, ItemStack p_36723_) {
   ...
   private void HitExplosion() {
      ...
      int damage2 = 20;
      this.playSound(SoundEvents.GENERIC_EXPLODE, 8.0F, 0.6F);
      for(Entity entity : list) {
         if (owner != entity && entity.getType() != EntityType.ITEM && entity.getType() != EntityType.EXPERIENCE_ORB && entity.getType() != EntityType.ARROW && entity.getType() != entityInit.ABYSS.get()) {
            entity.invulnerableTime = 0;
            entity.hurt(damagesource, damage2);
         }
      }
      Vec3 vec3 = new Vec3(x, y, z);
      packet.sendToAllClientsInDimention(new ExplosionParticle(vec3), this.level().dimension());
