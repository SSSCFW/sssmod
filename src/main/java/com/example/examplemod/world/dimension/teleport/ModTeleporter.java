package com.example.examplemod.world.dimension.teleport;

import com.example.examplemod.blocks.ModPortalBlock;
...
public class ModTeleporter implements ITeleporter {
    ...
    public Entity placeEntity(Entity entity, ServerLevel currentWorld, ServerLevel destinationWorld,
        ...
        if (insideDimension) {
            ...
            if (doSetBlock) {
                destinationWorld.setBlock(destinationPos, sssblocks.ORE_TELEPORT.get().defaultBlockState(), 3);
            }
        }
